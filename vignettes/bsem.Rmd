...
The guidelines in this document were divided into 5 subsequent sections: [installation](#installation), [description](#description), [usage](#usage), [graphical analysis](#graphical-analysis), and [remarks](#remarks).
...
```{r}
gridExtra::grid.arrange(bsem::arrayplot(lambda, main = "scores (lambda)", -4,4),
                        bsem::arrayplot(unifact$mean_scores, main = "scores estimate", -4,4),
...
The routines presented above are unprecedented. This document is part of the content submitted to [CRAN](https://cran.r-project.org/). The package is also in public use and is available at
