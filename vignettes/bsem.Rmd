...
cfa_fit <- bsem::sem(data = set2$set, blocks = set2$blocks,
                     paths = set2$paths, chains =1, scaled = F)

summary(cfa_fit)

p1 <- bsem::arrayplot(cfa_fit$scores, main = 'estimates', mini = -4, maxi = 4)
p2 <- bsem::arrayplot(set2$real$lambda, main = 'lambda (scores)', mini = -4, maxi = 4)

gridExtra::grid.arrange(p1, p2)

p1 <- bsem::arrayplot(cfa_fit$loadings, main = 'estimates', mini = -4, maxi = 4)
p2 <- bsem::arrayplot(set2$real$alpha, main = 'alpha (loadings)', mini = -4, maxi = 4)
