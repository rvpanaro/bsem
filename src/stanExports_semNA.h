...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(63, 61, "end", "model_semNA");
    return reader;
}
#include <stan_meta_header.hpp>
class model_semNA : public prob_grad {
private:
        int K;
        int Nv;
        int Ne;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_unconstrain(sigma2);
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma2 = in__.vector_constrain(Nv);
        size_t sigma2_j_1_max__ = Nv;
        for (size_t j_1__ = 0; j_1__ < sigma2_j_1_max__; ++j_1__) {
